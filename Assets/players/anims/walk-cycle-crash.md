# Walk Cycle Arrangement: Johnny Crash

**Spritesheet:** `Assets/players-web/spritesheets/crash.png`
...
path      = "Assets/players-web/spritesheets/crash.png"
frame_w   = 68
frame_h   = 96
order     = [0,1,2,3,4,5,3,7]  # order[slot] = source frame index
...
> **Note:** After running, only frames 0–7 are used by the game engine (BootScene `walk_crash` animation).
